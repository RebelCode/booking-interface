 ...
 *
 * Objects that implement this interface can be used as an argument for {@link BookingInterface::transition()}.
 * Therefore, the {@link __toString()} method SHOULD return a valid transition key. Any other arbitrary data can be
 * attached to the transition instance, which can be later retrieved via {@link ContainerInterface::get()}.
 *
